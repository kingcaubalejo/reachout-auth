...
type MemoryDatabaseRepo struct {
	users []*model.User
}

func InitMemoryDatabase() *MemoryDatabaseRepo {
	return &MemoryDatabaseRepo{
		users: []*model.User{
...
func (repo *MemoryDatabaseRepo) GetUsers() []*model.User {
	return repo.users
}

func (repo *MemoryDatabaseRepo) FindUserById(id string) *model.User {
...
func (repo *MemoryDatabaseRepo) Save(user *model.User) *model.User {
